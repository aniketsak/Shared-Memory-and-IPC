...
all:  verify sgverify libsnappyc.so.1 userapp
	gcc -o server server.c snappy.o map.o util.o -pthread
		
	
userapp: client.o	
	gcc -o userapp userapp.c client.o -pthread #change the user application name accordingly
snappy.o: snappy.c compat.h snappy-int.h

client.o: client.c 

CLEAN := server.o client.o snappy.o server client bench bench.o fuzzer.o fuzzer map.o verify.o \
